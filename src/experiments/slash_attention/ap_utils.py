...
def average_precision(pred, attributes, distance_threshold, dataset='', only_color=False, only_shape=False, only_shade=False, only_size=False, only_material=False, bg_encoded=True):
